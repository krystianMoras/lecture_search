...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--file_paths",
        required=True,
        help="Path to videos or audios (in wav and has to be 16khz)",
        nargs="+",
    )
    parser.add_argument(
        "--whisper_model_path", required=True, help="Path to whisper model"
    )
    parser.add_argument(
        "--whisper_executable_path", required=True, help="Path to whisper executable"
    )
