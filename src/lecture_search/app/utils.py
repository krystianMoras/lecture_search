...
def find_words_to_highlight(candidates:typing.List[str], words:typing.List[str],words_stemmed:typing.List[str]) -> typing.List[str]:
    highlights = []
    for candidate in candidates:
        ...
        if len(occurences) > 0:
            ...
            for occurence in occurences:
                highlight = " ".join(words[occurence:occurence+len(candidate_split)])
