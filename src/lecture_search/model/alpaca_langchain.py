...
#
# def get_documents(
#     paths: List[Path], da_pattern: str
# ) -> Tuple[List[Document], SimpleDocumentStore]:
...
#
#     key_phrase_table_index = KeyPhraseTableIndex(
#         nodes=nodes, service_context=service_context, key_phrases=key_phrases
#     )
#     return key_phrase_table_index, key_phrases
#
#
# if __name__ == "__main__":
#     key_phrase_table_index, key_phrases = get_index(
#         r"models\ggml-vicuna-7b-1.1-q4_0.bin",
#         [
#             Path("decision_analysis/da-lec1-notes.pdf"),
#             Path("decision_analysis/da-lec2-notes.pdf"),
#         ],
#         r"\[[0-9]+\]",
#         r"data/filtered_candidates.json",
#     )
#     print(
#         key_phrase_table_index.query(
#             "Describe partial ranking?", key_phrases=key_phrases
#         )
#     )
