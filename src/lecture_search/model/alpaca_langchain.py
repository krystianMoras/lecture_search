...
if __name__ == "__main__":
    key_phrase_table_index,key_phrases = get_index(r"models/alpaca-ggml-model-q4_0.bin", [Path("decision_analysis/da-lec1-notes.pdf"),Path("decision_analysis/da-lec2-notes.pdf")], r'\[[0-9]+\]', r"data/filtered_candidates.json")
